...
class DebugInfo
{
     ...
     */
    public function formatTemplateData($viewData = []): string
    {
        $log = '';
        reset($viewData);
     ...
     */
    public function formatGeneralInfo(): string
    {
    ...
    public function formatTimeStamp(): string
    {
        ...
        return $log . ("<div id='" . $className . "_timestamp'>Timestamp: " . microtime(true) . '</div>');
    }
}
