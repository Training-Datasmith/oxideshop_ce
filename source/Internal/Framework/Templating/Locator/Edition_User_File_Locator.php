...
class Edition_User_File_Locator implements Navigation_File_Locator_Interface
{
    private readonly string $theme_name;
    private string $file_name = 'user.xml';
    ...
    {
        $file_path = Path::join($this->context->get_edition_source_path($this->context->get_edition()), 'Application', 'views', $this->theme_name, $this->file_name);
