...
interface Module_Configuration_Merging_Service_Interface
{
    public function merge(Shop_Configuration $shop_configuration, Module_Configuration $module_configuration_to_merge): Shop_Configuration;
}